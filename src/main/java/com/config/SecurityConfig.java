    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/product/activate").hasAnyRole("ADMIN", "PRODUCT_MANAGER")
                        ...
                        .requestMatchers("/order/view/all").hasAnyRole("ADMIN", "PRODUCT_MANAGER")
                        .requestMatchers("/order/shipping-fee").permitAll()
                        .requestMatchers("/order/unassigned").hasAnyRole("ADMIN", "PRODUCT_MANAGER")
                        .requestMatchers("/order/shipper/").hasAnyRole("ADMIN", "PRODUCT_MANAGER")
                        .requestMatchers("/order/assign/").hasAnyRole("ADMIN", "PRODUCT_MANAGER")
                        .requestMatchers("/order/status/").hasAnyRole("ADMIN", "PRODUCT_MANAGER")
